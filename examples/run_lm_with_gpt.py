...
class DataTrainingArguments:
    ...
    train_data_file: Optional[str] = field(
        default='merged_pairs_train.txt', metadata={"help": "The input training data file (a text file)."}
    )
    eval_data_file: Optional[str] = field(
        default='merged_pairs_eval.txt',
...
def main():
    ...
    special_tokens_dict = {'additional_special_tokens': ['[DESCRIPTION]', '[INVENTORY]', '[FEEDBACK]', '[RESPONSE]'],
